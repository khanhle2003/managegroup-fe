...
// }
  ...
  exportAllExcel() {
    ...
    const headers = {
      ...
      dauthoigian: 'Đầu Thời Gian',
      DangVien: 'Đảng viên',
      lanhanvien: 'Là nhân viên',
      codcmoihaykhong: 'Có được mời hay không',
      baogomthoigiandichuyenchua: 'Bao gồm thời gian di chuyển chưa',
      ndcuthe: 'Nội dung cụ thể',
      bangiaocv: 'Bàn giao công việc',
      tentcmoi: 'Tên tổ chức, cá nhân mời',
      ndhoinghi: 'Nội dung hội nghị',
      songaynghiphep: 'Số ngày nghỉ phép',
      ndviecrieng: 'Nội dung việc riêng',
      tcngoaiBvtaitro: 'Tổ chức, cá nhân ngoài bệnh viện tài trợ',
      dangtaithumoi: 'Đang tại thư mời',
      Thongtindinhkem: 'Thông tin đính kèm',
      CCCD: 'CCCD',
      oral: 'Đăng tải chứng nhận/xác nhận báo cáo viên',
      qddinuocngoai: 'Quyết định đi nước ngoài',
      tinhtrangchuyendi: 'Tình trạng chuyến đi',
      emailLD: 'Email lãnh đạo',
      ngaydithucte: 'Ngày đi thực tế',
      ngaydenthucte: 'Ngày đến thực tế',
      baocaotomtat: 'Báo cáo tóm tắt',
      tiepxuccoquan: 'Tiếp xúc cơ quan',
      viechaphanhbaovebimatnn: 'Việc chấp hành bảo vệ bí mật Nhà nước',
      vdelienquandenchinhtrinoibo: 'Vấn đề liên quan đến chính trị nội bộ',
      hdngoaikehoach: 'Hoạt động ngoài kế hoạch',
      Certificate: 'Chứng chỉ',
      ndynghiaapdungvatrienkhaibenhvien: 'Nội dung ý nghĩa áp dụng và triển khai bệnh viện',
      dexuatkiennghi: 'Đề xuất kiến nghị',
      ttquyetdinh: 'Tình trạng quyết định',
      lydohoan: 'Lý do hoãn',
      ndchuyendibihoan: 'Nội dung chuyến đi bị hoãn',
      mayte: 'Máy tính',
      editURL: 'URL chỉnh sửa',
      docURL: 'URL tài liệu',
      increment: 'Tăng',
      pdfURL: 'URL PDF',
      restCount: 'Số lần nghỉ',
    };
    ...
    const dataFormatted = this.originalData.map(item => {
      return {
        ...
        'Khác': item.khac,
        // Các trường bổ sung từ entity
        'Đầu Thời Gian': item.dauthoigian,
        'Là nhân viên': item.lanhanvien,
        'Có được mời hay không': item.codcmoihaykhong,
        'Bao gồm thời gian di chuyển chưa': item.baogomthoigiandichuyenchua,
        'Nội dung cụ thể': item.ndcuthe,
        'Bàn giao công việc': item.bangiaocv,
        'Tên tổ chức, cá nhân mời': item.tentcmoi,
        'Nội dung hội nghị': item.ndhoinghi,
      
        'Nội dung việc riêng': item.ndviecrieng,
        'Tổ chức, cá nhân ngoài bệnh viện tài trợ': item.tcngoaiBvtaitro,
        'Đang tại thư mời': item.dangtaithumoi,
        'Thông tin đính kèm': item.thongtindinhkem,
        'CCCD': item.cccd,
        'Đăng tải chứng nhận/xác nhận báo cáo viên': item.oral,
        'Quyết định đi nước ngoài': item.qddinuocngoai,
        'Tình trạng chuyến đi': item.tinhtrangchuyendi,
        'Email lãnh đạo': item.emailLD,
        'Ngày đi thực tế': item.ngaydithucte,
        'Ngày đến thực tế': item.ngaydenthucte,
        'Báo cáo tóm tắt': item.baocaotomtat,
        'Tiếp xúc cơ quan': item.tiepxuccoquan,
        'Việc chấp hành bảo vệ bí mật Nhà nước': item.viechaphanhbaovebimatnn,
        'Vấn đề liên quan đến chính trị nội bộ': item.vdelienquandenchinhtrinoibo,
        'Hoạt động ngoài kế hoạch': item.hdngoaikehoach,
        'Chứng chỉ': item.Certificate,
        'Nội dung ý nghĩa áp dụng và triển khai bệnh viện': item.ndynghiaapdungvatrienkhaibenhvien,
        'Đề xuất kiến nghị': item.dexuatkiennghi,
        'Tình trạng quyết định': item.ttquyetdinh,
        'Lý do hoãn': item.lydohoan,
        'Nội dung chuyến đi bị hoãn': item.ndchuyendibihoan,
        'Máy tính': item.mayte,
        'URL chỉnh sửa': item.editURL,
        'URL tài liệu': item.docURL,
        'Tăng': item.increment,
        'URL PDF': item.pdfURL,
        'Số lần nghỉ': item.restCount,
      };
    });
